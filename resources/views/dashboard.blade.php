...
@section('content')
    ...
    <section id="layanan">
        <div class="container text-center">
            ...
            <div class="row justify-content-around styleLayanan">
                
                    <div class="col-md-4 stylecolLayanan imgicon" >
                    ...
                    <div class="col-md-4 imgicon" >
                        <img src="chatIcon.png" alt="Icon Buku" width="50" height="50" style="padding-bottom: 10px">
                        <h6 class="teksicon">Chat Admin</h6>
                        <a href="https://linktr.ee/AdminITech" style="text-decoration: none; color: blue" class="teksicon">Read More</a>
                    </div>
            </div>
        </div>
    </section>
